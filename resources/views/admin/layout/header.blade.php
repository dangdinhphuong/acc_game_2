<header class="container-fluid d-flex py-6 mb-4">
    ...
    <div class="d-flex align-items-center ms-auto me-n1 me-lg-n2">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                    <a href="javascript: void(0);" class="dropdown-item active">
                        <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img"
                                src="https://d33wubrfki0l68.cloudfront.net/8ab0a140561aa1ea23abaa0101bd41b9b1d0cb12/e951b/assets/images/flags/1x1/us.svg"
                                alt="..." width="18" height="18" /></span><span
                            class="text-truncate ms-2">English (US)</span>
                    </a>
                </li>
                <li>
                    <a href="javascript: void(0);" class="dropdown-item">
                        <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img"
                                ...
                                alt="..." width="18" height="18" /></span><span
                            class="text-truncate ms-2">English (UK)</span>
                    </a>
                </li>
                <li>
                    <a href="javascript: void(0);" class="dropdown-item">
                        <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img"
                                ...
                                alt="..." width="18" height="18" /></span><span
                            class="text-truncate ms-2">Español</span>
                    </a>
                </li>
                <li>
                    <a href="javascript: void(0);" class="dropdown-item">
                        <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img"
                                ...
                                alt="..." width="18" height="18" /></span><span
                            class="text-truncate ms-2">Française</span>
                    </a>
                </li>
                <li>
                    <a href="javascript: void(0);" class="dropdown-item">
                        <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img"
                                ...
                                alt="..." width="18" height="18" /></span><span
                            class="text-truncate ms-2">Deutsch</span>
                    </a>
                </li>
                <li>
                    <a href="javascript: void(0);" class="dropdown-item">
                        <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img"
                                ...
                                alt="..." width="18" height="18" /></span><span
                            class="text-truncate ms-2">中文 (繁體)</span>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="offcanvas-body p-0">
                <div class="list-group list-group-flush">
                    ...
                    <a href="javascript: void(0);" class="list-group-item list-group-item-action">
                        <div class="d-flex">
                            <div class="avatar avatar-circle avatar-xs me-2">
                                <img src="../d33wubrfki0l68.cloudfront.net/9f5880fc99a40d5021e5a133fe72f232e3883d3a/c965d/assets/images/profiles/profile-13.jpg"
                                    alt="..." class="avatar-img" width="30" height="30">
                            </div>
                    ...
                    <a href="javascript: void(0);" class="list-group-item list-group-item-action">
                        <div class="d-flex">
                            <div class="avatar avatar-circle avatar-xs me-2">
                                <img src="../d33wubrfki0l68.cloudfront.net/102e41d9e1988e0849ecfe402b1d46f4efd3574b/8dc2e/assets/images/profiles/profile-12.jpg"
                                    alt="..." class="avatar-img" width="30" height="30">
                            </div>
                    ...
                    <a href="javascript: void(0);" class="list-group-item list-group-item-action">
                        <div class="d-flex">
                            <div class="avatar avatar-circle avatar-xs me-2">
                                <img src="../d33wubrfki0l68.cloudfront.net/eec1f115f0af81936bbe3a4f4a4d043cd3c0e7e4/34439/assets/images/profiles/profile-09.jpg"
                                    alt="..." class="avatar-img" width="30" height="30">
                            </div>
                    ...
                    <a href="javascript: void(0);" class="list-group-item list-group-item-action">
                        <div class="d-flex">
                            <div class="avatar avatar-circle avatar-xs me-2">
                                <img src="../d33wubrfki0l68.cloudfront.net/e83422b2242219796524c41b945eb0a4b4b75dfd/caa0b/assets/images/profiles/profile-08.jpg"
                                    alt="..." class="avatar-img" width="30" height="30">
                            </div>
                    ...
                    <a href="javascript: void(0);" class="list-group-item list-group-item-action">
                        <div class="d-flex">
                            <div class="avatar avatar-circle avatar-xs me-2">
                                <img src="../d33wubrfki0l68.cloudfront.net/790b7dd581a3ac4fd0410afad0fb12c6e93c9e7a/b0657/assets/images/profiles/profile-07.jpg"
                                    alt="..." class="avatar-img" width="30" height="30">
                            </div>
                    ...
                    <a href="javascript: void(0);" class="list-group-item list-group-item-action">
                        <div class="d-flex">
                            <div class="avatar avatar-circle avatar-xs me-2">
                                <img src="../d33wubrfki0l68.cloudfront.net/4b8c918c73e2c72876e4bd4ba8c89401bae69d14/5923c/assets/images/profiles/profile-03.jpg"
                                    alt="..." class="avatar-img" width="30" height="30">
                            </div>
            ...
            <a href="javascript: void(0);"
                ...
                <svg viewBox="0 0 24 24" height="18" width="18"
                    ...
                    <path d="M11.471 15.712L6.881 20.301" fill="none" stroke="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                    <path d="M6.881 3.7L11.471 8.289" fill="none" stroke="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                    <path d="M8.289 11.471L3.699 6.881" fill="none" stroke="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                    <path d="M20.301 6.881L15.711 11.471" fill="none" stroke="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                    <path d="M12.529 8.289L17.119 3.7" fill="none" stroke="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                                ...
                                <span class="avatar avatar-xs d-flex align-items-center mx-auto mb-1">
                                    <svg class="avatar-img mx-auto" viewBox="2.59 0 214.09101008 224"
                                        ...
                                        <linearGradient id="a"
                                            ...
                                            gradientUnits="userSpaceOnUse" x1="102.4" x2="56.15"
                                            y1="218.63" y2="172.39">
                                            <stop offset=".18" stop-color="#0052cc" />
                                            <stop offset="1" stop-color="#2684ff" />
                                        </linearGradient>
                                        <linearGradient id="b" x1="114.65" x2="160.81"
                                            xlink:href="#a" y1="85.77" y2="131.92" />
                                        <path
                                    ...
                                    <svg class="avatar-img mx-auto" viewBox="0 0 42 37"
                                        ...
                                        <g stroke="none" stroke-width="1" fill="none"
                                            ...
                                            <g transform="translate(-59.000000, -214.000000)" fill="#0062FF"
                                                fill-rule="nonzero">
                                                <g id="Storages"
                                                    transform="translate(30.000000, 183.000000)">
                                                    <g id="logo"
                        ...
                        <div class="col-4 d-flex justify-content-center align-items-center">
                            <a href="javascript: void(0);"
                                ...
                                <span class="avatar avatar-xs avatar-circle">
                                    <svg class="avatar-img mx-auto" clip-rule="evenodd"
        ...
        <a class="d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px link-secondary"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="18"
                width="18">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCustomize"
            ...
            <div class="offcanvas-body pt-7 pb-5 position-relative">
                ...
                <div class="btn-group w-100 mb-7" role="group" aria-label="Light/dark switcher">
                    <input type="radio" class="btn-check" name="theme" id="lightMode"
                    ...
                    <input type="radio" class="btn-check" name="theme" id="darkMode"
                    ...
                    <input type="radio" class="btn-check" name="theme" id="autoMode"
