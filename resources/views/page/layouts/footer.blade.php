<footer class="footer">
            ...
            <div class="footer__content">
                <div class="footer__info">
                    ...
                    <p class="description">
                        ...
                        hy vọng chúng tôi sẽ được phục vụ các bạn. Cảm ơn!
                    </p>
                    <h4 class="title-sub">Thời gian hỗ trợ:</h4>
                    <p class="description">
                        Sáng: 8h00 -> 11h30 | Chiều: 13h00 -> 19h00
                    </p>
                </div>
                <div class="footer__contact">
                    <h1 class="title">SEONGSHOP.COM</h1>
                    <p class="description">
                        HỆ THỐNG BÁN ACC TỰ ĐỘNG ĐẢM BẢO UY TÍN VÀ CHẤT LƯỢNG.
                    </p>
                    <button class="footer__inbox">
                        <div class="icon">
    ...
    <div class="footer__end">
        <p>Vận hành bởi <a href="">WonJunSeong</a>, All Rights Reserved.</p>
    </div>
</footer>